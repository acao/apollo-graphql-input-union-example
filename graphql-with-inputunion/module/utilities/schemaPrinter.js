...
import { isScalarType, isObjectType, isInterfaceType, isUnionType, isInputUnionType, isEnumType, isInputObjectType } from '../type/definition';
...
function printInputUnion(type, options) {
  return printDescription(options, type) + ('inputUnion ' + type.name + ' = ' + type.getTypes().join(' | '));
}
