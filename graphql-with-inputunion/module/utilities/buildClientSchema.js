...
import { isInputType, isOutputType, isInputObjectType, GraphQLScalarType, GraphQLObjectType, GraphQLInterfaceType, GraphQLUnionType, GraphQLInputUnionType, GraphQLEnumType, GraphQLInputObjectType, assertNullableType, assertObjectType, assertInterfaceType } from '../type/definition';
...
export function buildClientSchema(introspection, options) {
  ...
  function getInputObjectType(typeRef) {
    var type = getType(typeRef);
    !isInputObjectType(type) ? invariant(0, 'Introspection must provide input type for arguments.') : void 0;
    return type;
  }
