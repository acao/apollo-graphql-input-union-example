...
import { GraphQLObjectType, GraphQLEnumType, isScalarType, isObjectType, isInterfaceType, isUnionType, isInputUnionType, isEnumType, isInputObjectType, isListType, isNonNullType, isAbstractType, isNamedType } from './definition';
...
export var __TypeKind = new GraphQLEnumType({
  ...
  values: {
    ...
    INPUT_UNION: {
      ...
      description: 'Indicates this type is a union of input objects. ' + '`possibleTypes` is a valid field.'
    },
    ENUM: {
      value: TypeKind.ENUM,
