...
export function assertInputUnionType(type) {
  !isInputUnionType(type) ? invariant(0, 'Expected ' + String(type) + ' to be a GraphQL Input Union type.') : void 0;
  return type;
}
 ...
 *
 */
export var GraphQLInputUnionType = function () {
  ...
  GraphQLInputUnionType.prototype._defineTypeMap = function _defineTypeMap() {
    ...
    !Array.isArray(types) ? invariant(0, 'Must provide Array of types or a function which returns ' + ('such an array for Input Union ' + this.name + '.')) : void 0;
