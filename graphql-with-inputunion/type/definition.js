...
exports.GraphQLInputUnionType = exports.GraphQLInputObjectType = exports.GraphQLEnumType = exports.GraphQLUnionType = exports.GraphQLInterfaceType = exports.GraphQLObjectType = exports.GraphQLScalarType = undefined;
...
exports.isInputUnionType = isInputUnionType;
exports.assertInputUnionType = assertInputUnionType;
...
function isType(type) {
  return isScalarType(type) || isObjectType(type) || isInterfaceType(type) || isUnionType(type) || isInputUnionType(type) || isEnumType(type) || isInputObjectType(type) || isListType(type) || isNonNullType(type);
}
...
// eslint-disable-next-line no-redeclare
function isInputUnionType(type) {
  return (0, _instanceOf2.default)(type, GraphQLInputUnionType);
}

function assertInputUnionType(type) {
  !isInputUnionType(type) ? (0, _invariant2.default)(0, 'Expected ' + String(type) + ' to be a GraphQL Input Union type.') : void 0;
  return type;
}
...
function isInputType(type) {
  return isScalarType(type) || isEnumType(type) || isInputObjectType(type) || isInputUnionType(type) || isWrappingType(type) && isInputType(type.ofType);
}
...
function isNamedType(type) {
  return isScalarType(type) || isObjectType(type) || isInterfaceType(type) || isUnionType(type) || isInputUnionType(type) || isEnumType(type) || isInputObjectType(type);
}
 ...
 *
 */
var GraphQLInputUnionType = exports.GraphQLInputUnionType = function () {
  function GraphQLInputUnionType(config) {
    _classCallCheck(this, GraphQLInputUnionType);
  ...
  GraphQLInputUnionType.prototype.getTypes = function getTypes() {
    var _this2 = this;

    return this._types || (this._types = Object.keys(this.getTypeMap()).map(function (typename) {
      return _this2._typeMap[typename];
    }));
  };

  GraphQLInputUnionType.prototype.getTypeMap = function getTypeMap() {
    return this._typeMap || (this._typeMap = this._defineTypeMap());
  };

  GraphQLInputUnionType.prototype._defineTypeMap = function _defineTypeMap() {
    var types = resolveThunk(this._typeConfig.types) || [];
    !Array.isArray(types) ? (0, _invariant2.default)(0, 'Must provide Array of types or a function which returns ' + ('such an array for Input Union ' + this.name + '.')) : void 0;
    var resultTypeMap = Object.create(null);
  ...
  GraphQLInputUnionType.prototype.toString = function toString() {
    return this.name;
  };

  return GraphQLInputUnionType;
}();

// Also provide toJSON and inspect aliases for toString.


GraphQLInputUnionType.prototype.toJSON = GraphQLInputUnionType.prototype.inspect = GraphQLInputUnionType.prototype.toString;